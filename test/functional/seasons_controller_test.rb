...
class SeasonsControllerTest < ActionController::TestCase
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post :create, season: { from: @season.from, mos: @season.mos, name: @season.name, to: @season.to, winners: @season.winners }
    end
  ...
  test "should update season" do
    put :update, id: @season, season: { from: @season.from, mos: @season.mos, name: @season.name, to: @season.to, winners: @season.winners }
    assert_redirected_to season_path(assigns(:season))
  end
